...
import { SelectUser, UpdateUser, DeleteUser, LoadUsers, CloseMessageUser, AddUser } from '../../reducers/reducers/user.actions';
import { UserService } from 'src/app/services/user.service';
import { Store } from '@ngrx/store';
import { State as UserState } from '../../reducers/reducers/user.reducer';
...
export class UsuariosMasterComponent {
  ...
  constructor(private store: Store<RootState>, private userService: UserService) {
    ...
    this.store.dispatch( new LoadUsers(this.userService.getAll()) );
  }
